...
struct ClassAnnotations {
  ...
  struct FlagPrinter {
    ...
    explicit FlagPrinter(ClassAnnotations const *ref)
        : annotations(ref) {}
  };
...
inline raw_ostream &operator<<(raw_ostream &os,
                               ClassAnnotations::FlagPrinter const &p) {
  os << "Class::kFlagsNull";
...
struct PropertyAnnotations {
  ...
  struct FlagPrinter {
    ...
    explicit FlagPrinter(PropertyAnnotations const *ref)
        : annotations(ref) {}
  };
...
struct FunctionAnnotations {
  ...
  struct FlagPrinter {
    ...
    explicit FlagPrinter(FunctionAnnotations const *ref)
        : annotations(ref) {}
  };
